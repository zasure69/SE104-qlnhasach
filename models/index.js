...
DauSach.belongsToMany(TacGia, { through: CT_TacGia, foreignKey: 'MaDauSach' });
TacGia.belongsToMany(DauSach, { through: CT_TacGia, foreignKey: 'MaTacGia' });
...
PhieuNhapSach.belongsToMany(Sach, { through: CT_PNS, foreignKey: 'MaPhieuNhap' });
