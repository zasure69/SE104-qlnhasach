...
// Đầu sách
router.get("/dausach/deleted", authorizeAdmin, bookController.getDeletedDauSach);
router.patch("/dausach/restore/:maDS", authorizeAdmin, bookController.restoreDauSach);
router.delete("/dausach/hard-delete/:maDS", authorizeAdmin, bookController.hardDeleteDauSach);

// Sách
router.get("/sach/deleted", authorizeAdmin, bookController.getDeletedSach);
router.patch("/sach/restore/:maSach", authorizeAdmin, bookController.restoreSach);
router.delete("/sach/hard-delete/:maSach", authorizeAdmin, bookController.hardDeleteSach);

// Thể loại
router.get("/types/deleted", authorizeAdmin, bookController.getDeletedTheLoai);
router.patch("/types/restore/:maTheLoai", authorizeAdmin, bookController.restoreTheLoai);
router.delete("/types/hard-delete/:maTheLoai", authorizeAdmin, bookController.hardDeleteTheLoai);

// Tác giả
router.get("/authors/deleted", authorizeAdmin, bookController.getDeletedTacGia);
router.patch("/authors/restore/:maTacGia", authorizeAdmin, bookController.restoreTacGia);
router.delete("/authors/hard-delete/:maTacGia", authorizeAdmin, bookController.hardDeleteTacGia);
